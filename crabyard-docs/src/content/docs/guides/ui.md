...
Crabyard supports four UI frameworks. You choose one during project generation with `--ui <framework>`, or switch later with `crabyard update-ui --switch <framework>`.
