...
TauriKit includes a built-in splash screen that displays instantly while your React app loads. Once the frontend finishes loading, the splash screen closes and the main window appears.
