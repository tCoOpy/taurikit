...
description: Configure GitHub, Google, or no authentication in your TauriKit app.
---

TauriKit supports three auth modules. You choose one during project generation with `--auth <module>`.
