...
Every generated TauriKit app includes a settings system backed by [tauri-plugin-store](https://v2.tauri.app/plugin/store/) and [Zustand](https://zustand.docs.pmnd.rs/).
