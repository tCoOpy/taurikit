...
const uiCode = `<span class="text-zinc-600">$</span> <span class="text-brand-400">taurikit</span> <span class="text-zinc-200">new</span> <span class="text-zinc-600">--ui</span>
...
<span class="text-zinc-600">$</span> <span class="text-brand-400">taurikit</span> <span class="text-zinc-200">update-ui daisyui</span>
      ...
      <div className="max-w-6xl mx-auto">
        <AnimateIn className="text-center mb-20">
          ...
          <p className="mt-4 text-zinc-500 text-lg max-w-2xl mx-auto font-light">
            Stop wiring boilerplate. TauriKit gives you a complete foundation so
