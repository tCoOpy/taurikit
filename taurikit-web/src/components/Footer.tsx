      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-zinc-600">
              ...
              <li>
                <a
                  href="https://github.com/tCoOpy/taurikit"
                  className="hover:text-zinc-300 transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="mailto:support@taurikit.dev"
                  className="hover:text-zinc-300 transition-colors"
                >
                  Support
                </a>
        ...
        <div className="border-t border-zinc-900 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-zinc-700">
            &copy; {new Date().getFullYear()} TauriKit. All rights reserved.
          </p>
